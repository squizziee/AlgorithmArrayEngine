...
public abstract class AAE {
	...
	public static void showInfo(int[] arr) {
		...
		System.out.println("Status : " + AAE.isSorted(arr));
		System.out.println("Number of elements : " + AAE.getNumberOfElements(arr));
		System.out.println("Biggest element : " + AAE.max(arr));
		System.out.println("Smallest element : " + AAE.min(arr));
	 }
}